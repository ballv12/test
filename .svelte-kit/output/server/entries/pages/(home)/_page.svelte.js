...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Meta, "Meta").$$render($$result, { title: "Ball", description: "Website." }, {}, {})} <main class="wrapper fade"><h1 class="header" data-svelte-h="svelte-11bsm05">Bell</h1> <p class="mt-4 text-gray-400" data-svelte-h="svelte-s5m9ze">Backflip enthusiast, and software developer.</p> <div class="mt-4 flex gap-6">${validate_component(SocialLink, "SocialLink").$$render(
    $$result,
    {
      href: "https://discord.com/users/607846264293556237",
      name: "Discord"
    },
    {},
    {
  ...
  )} ${validate_component(SocialLink, "SocialLink").$$render($$result, { href: "ballv@gmail.org", name: "Email" }, {}, {
    default: () => {
