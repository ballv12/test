...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies__spotify_web_api_ts_sdk: string;
	...
	export const npm_package_dependencies_sk_lanyard: string;
	...
	export const npm_package_devDependencies__types_dom_view_transitions: string;
	export const npm_package_devDependencies_autoprefixer: string;
	export const npm_package_devDependencies_svelte_check: string;
	export const HOME: string;
	export const SHLVL: string;
	export const npm_package_type: string;
	export const npm_package_devDependencies__types_estree: string;
	export const VSCODE_GIT_ASKPASS_MAIN: string;
	export const HOMEBREW_PREFIX: string;
	export const npm_package_devDependencies_postcss_each: string;
	...
	export const npm_package_devDependencies__types_pug: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		NVM_INC: string;
		npm_package_dependencies__spotify_web_api_ts_sdk: string;
		...
		npm_package_dependencies_sk_lanyard: string;
		...
		npm_package_devDependencies__types_dom_view_transitions: string;
		npm_package_devDependencies_autoprefixer: string;
		npm_package_devDependencies_svelte_check: string;
		HOME: string;
		SHLVL: string;
		npm_package_type: string;
		npm_package_devDependencies__types_estree: string;
		VSCODE_GIT_ASKPASS_MAIN: string;
		HOMEBREW_PREFIX: string;
		npm_package_devDependencies_postcss_each: string;
		LOGNAME: string;
		...
		npm_package_devDependencies__types_pug: string;
